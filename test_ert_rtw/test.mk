...
## 
## Makefile     : test.mk
## Generated on : Tue Mar 29 17:57:04 2022
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\test.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\test.exe
...
SRCS = $(START_DIR)\test_ert_rtw\test.c

MAIN_SRC = $(START_DIR)\test_ert_rtw\ert_main.c
...
{$(START_DIR)\test_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\test_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : $(START_DIR)\test_ert_rtw\ert_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\test_ert_rtw\ert_main.c


test.obj : $(START_DIR)\test_ert_rtw\test.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\test_ert_rtw\test.c
