...
## Generated on : Wed Jun 22 15:33:33 2022
...
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=1 -DMAT_FILE=1 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=1 -DINTEGER_CODE=0 -DMT=0
DEFINES_CUSTOM = 
DEFINES_OPTS = -DRT_MALLOC -DTID01EQ=0
DEFINES_STANDARD = -DMODEL=sf_simulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/sf_simulink_grt_rtw/rtGetInf.c $(START_DIR)/sf_simulink_grt_rtw/rtGetNaN.c $(START_DIR)/sf_simulink_grt_rtw/rt_nonfinite.c $(START_DIR)/sf_simulink_grt_rtw/sf_simulink.c
...
OBJS = rt_logging.o rtGetInf.o rtGetNaN.o rt_nonfinite.o sf_simulink.o
...
%.o : $(START_DIR)/sf_simulink_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/sf_simulink_grt_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/sf_simulink_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/sf_simulink_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/sf_simulink_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rtGetInf.o : $(START_DIR)/sf_simulink_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/sf_simulink_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/sf_simulink_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sf_simulink.o : $(START_DIR)/sf_simulink_grt_rtw/sf_simulink.c
	$(CC) $(CFLAGS) -o "$@" "$<"
