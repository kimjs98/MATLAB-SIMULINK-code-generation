function CodeDefine() { 
this.def = new Array();
this.def["RT_MEMORY_ALLOCATION_ERROR"] = {file: "ert_main_c.html",line:25,type:"var"};
this.def["rt_OneStep"] = {file: "ert_main_c.html",line:39,type:"fcn"};
this.def["main"] = {file: "ert_main_c.html",line:76,type:"fcn"};
this.def["sf_simulink_rtZOUTPUT"] = {file: "sf_simulink_c.html",line:39,type:"var"};
this.def["sf_simulink_step"] = {file: "sf_simulink_c.html",line:50,type:"fcn"};
this.def["sf_simulink_initialize"] = {file: "sf_simulink_c.html",line:313,type:"fcn"};
this.def["sf_simulink_terminate"] = {file: "sf_simulink_c.html",line:346,type:"fcn"};
this.def["sf_simulink"] = {file: "sf_simulink_c.html",line:357,type:"fcn"};
this.def["B_sf_simulink_T"] = {file: "sf_simulink_h.html",line:50,type:"type"};
this.def["DW_sf_simulink_T"] = {file: "sf_simulink_h.html",line:70,type:"type"};
this.def["ExtU_sf_simulink_T"] = {file: "sf_simulink_h.html",line:77,type:"type"};
this.def["ExtY_sf_simulink_T"] = {file: "sf_simulink_h.html",line:82,type:"type"};
this.def["CAM"] = {file: "sf_simulink_types_h.html",line:35,type:"type"};
this.def["LIDAR"] = {file: "sf_simulink_types_h.html",line:47,type:"type"};
this.def["CORE"] = {file: "sf_simulink_types_h.html",line:56,type:"type"};
this.def["OUTPUT"] = {file: "sf_simulink_types_h.html",line:71,type:"type"};
this.def["CHECK"] = {file: "sf_simulink_types_h.html",line:85,type:"type"};
this.def["ACCIDENT"] = {file: "sf_simulink_types_h.html",line:99,type:"type"};
this.def["RT_MODEL_sf_simulink_T"] = {file: "sf_simulink_types_h.html",line:104,type:"type"};
...
var fileList = [
"ert_main_c.html","sf_simulink_c.html","sf_simulink_h.html","sf_simulink_private_h.html","sf_simulink_types_h.html","rtGetInf_c.html","rtGetInf_h.html","rtGetNaN_c.html","rtGetNaN_h.html","rt_nonfinite_c.html","rt_nonfinite_h.html","rtwtypes_h.html"];
